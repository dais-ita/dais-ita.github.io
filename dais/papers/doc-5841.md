...
<table>
    ...
    <tr>
        ...
        <tr>
            <td colspan="2">
                <form method="get" action="https://ibm.box.com/v/doc-5841-paper">
                    <button type="submit">download paper</button>
                </form>
                <form method="get" action="https://ibm.box.com/v/doc-5841-slides">
                    <button type="submit">download presentation</button>
                </form>
                <form method="get" action="https://ibm.box.com/v/doc-5841-poster">
