...
<table>
    ...
    <tr>
        ...
        <tr>
            <td colspan="2">
                <form method="get" action="https://ibm.box.com/v/doc-5827-paper">
                    <button type="submit">download paper</button>
                </form>
                <form method="get" action="https://ibm.box.com/v/doc-5827-slides">
                    <button type="submit">download presentation</button>
                </form>
                <form method="get" action="https://ibm.box.com/v/doc-5827-poster">
        ...
        <tr>
            ...
            <td>
                <ul>
                    <li><a href="\doc-4763\">doc-4763</a></li>
                </ul>
            </td>
        </tr>
    </tbody>
